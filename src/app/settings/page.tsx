...
export default function SettingsPage() {
    ...
    return (
        <div className="flex h-screen w-full overflow-hidden bg-[#efede7] dark:bg-black font-sans">
            ...
            <aside className="w-80 flex-shrink-0 h-full flex flex-col border-r border-black/5 dark:border-white/10 bg-white dark:bg-black transition-colors duration-300">
            ...
            {/* Right Content Area */}
            <main className="flex-1 h-full relative bg-zinc-900 text-white">
                {/* Background & Overlay */}
                ...
                {/* Content Container - Centrally Constrained */}
