...
// Export action buttons for inline use in pages
...
function Sidebar() {
    ...
    return (
        <aside className="w-64 flex-shrink-0 h-full flex flex-col bg-transparent">
            {/* Logo */}
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="flex h-screen bg-zinc-100 dark:bg-[#111111] overflow-hidden">
            {/* Persistent Sidebar */}
            <Sidebar />

            {/* Main Content Area with Panel */}
            <main className="flex-1 p-6 overflow-hidden">
                <div className="h-full w-full rounded-[32px] bg-white dark:bg-[#171717] border border-zinc-200 dark:border-zinc-800 shadow-sm dark:shadow-none overflow-y-auto">
                    {children}
                </div>
            </main>
        </div>
